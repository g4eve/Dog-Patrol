...
You can enroll a new user in the To-Do service. To do so, `POST` a new [`dog sitter` (_coming soon_)](../api/dog-sitter) resource containing the dog sitter's details.
...
* [Dog sitter resource _coming soon_](../api/dog-sitter)
